							...
							<div class="row">
								<div class="col-md-12">
									<table class="table table-bordered table-hover">
										<thead>
											<tr class="">
												<th class="col-md-3">@lang('performance.category_name')</th>
												<th class="col-md-3">@lang('performance.criteria_name') </th>
												<th class="col-md-2">Judgement</th>
												<th class="col-md-2">Comments</th>
												<th class="col-md-2">@lang('performance.rating') (@lang('performance.out_of_ten'))</th>
											</tr>
										</thead>
										<tbody>
											@php
											...
											@foreach($criteriaDataFormat as $key => $value)
												<tbody class="report_row">
													<tr>
														...
														<td>{{$value[0]['judgement']}}</td>
														<td>{{$value[0]['comments']}}</td>
														<td>
															{{$value[0]['rating']}}
															@php
											...
											@endforeach
											<tr>
												<td colspan="4" class="text-right">  <b>@lang('performance.total_rating') :</b></td>
												<td> <b>{{$totalRating}}</b></td>
											</tr>
											<tr>
												<td colspan="4" class="text-right">  <b>@lang('performance.average_rating') :</b></td>
												<td>
													<b>
														@php
											...
											<tr>
												<td colspan="4" class="text-right">  <b>@lang('performance.star_rating') :</b></td>
												<td>
