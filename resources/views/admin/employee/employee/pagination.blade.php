            ...
            <tr class="{!! $value->employee_id !!}">
                ...
                <td>
					...
					<br/><span class="text-muted">
						@if (isset($value->supervisor->first_name)) @lang('employee.reporting_superior') :  {!! $value->supervisor->first_name !!} {!! $value->supervisor->last_name !!}@endif
					</span>
                </td>
                <td>
					<span class="font-medium">
                ...
                {{-- <td>
                    <span class="font-medium">
                         @if (isset($value->payGrade->pay_grade_name)) {!! $value->payGrade->pay_grade_name!!} <span class="bdColor">
                             (@lang('employee.monthly'))</span>
                         @endif
                ...
                {{-- <td>
                    ...
                    <br/><span class="text-muted">
                        ...
                        @elseif($value->permanent_status == 2) 
                            Contractual
                         @else
