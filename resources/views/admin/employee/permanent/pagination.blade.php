    ...
    <table  class="table table-hover manage-u-table">
        <thead>
			<tr>
				...
				<th title="Employee ID Number">@lang('employee.employee_id_number')</th>
            ...
            <tr class="{!! $value->employee_id !!}">
                ...
                <td>
					...
					<br/><span class="text-muted">
						@if (isset($value->supervisor->first_name)) Reporting/Superior :  {!! $value->supervisor->first_name !!} {!! $value->supervisor->last_name !!}@endif
					</span>
                </td>
                <td>
					<span class="font-medium">
                ...
                <td>
                    <span class="font-medium">
                         @if (isset($value->payGrade->pay_grade_name)) {!! $value->payGrade->pay_grade_name!!} 
                         {{-- <span class="bdColor">(Monthly)</span> --}}
                        @endif
