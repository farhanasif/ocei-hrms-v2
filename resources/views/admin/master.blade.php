...
<body class="fix-header" onload="addMenuClass()">
    ...
    <div id="wrapper">
                ...
                <div class="top-left-part">
                    ...
                    <a class="logo" href="{{ url('dashboard') }}">
                        <!-- Logo icon image, you can use font-icon also --><b>
                            ...
                            {{-- <h3 class="text-white">OCEI</h3> --}}
                            <img style="width: 200px; height:59.5px;object-fit: fill;"
                                src="{{ asset('admin_assets/img/processed.jpeg') }}" alt="home"
                                class="dark-logo img-fluid img-responsive" />
                            {{-- <img style="width: 75px;" src="{{ url('uploads/front/'.$front_setting->logo) }}" alt="home" class="dark-logo img-fluid img-responsive"/> --}}
                        </b>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    ?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                ...
                                class="hidden-xs "
                                style="color: #479e11 !important;">{!! $employeeInfo[0]->user_name !!}</b><span
                                class="caret"></span>
                        </a>
                        <?php  }else{ ?>
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                src="{!! asset('admin_assets/img/default.png') !!}" alt="user-img" width="36" class="img-circle"><b
                                class="hidden-xs" style="color: #479e11 !important; "><span class="hideMenu"
                                    style="color: #479e11 !important;">{!! $employeeInfo[0]->user_name !!}</span></b><span
                                class="caret hideMenu"></span> </a>
                        <?php } ?>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            <li><a href="{{ url('profile') }}"><i class="ti-user"></i>
                                    @lang('common.my_profile')</a></li>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    {{-- <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize hideMenu mdi mdi-calendar-clock"></i> Event & Meeting <span
                                class="hide-menu hideMenu">&nbsp;<span class="fa arrow"></span></span>
                        </a>
                        ...
                        <ul class="treeview-menu nav nav-second-level">
                            <li>
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="hideMenu">Event</span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('meeting.page') }}">
                                    <i data-icon="/" class="linea-icon linea-basic fa-fw"></i>
                                    <span class="hideMenu">Meeting</span>
                                </a>
                            </li>
                                    ...
                                    $menuItem .=
                                        '<li>
                                            <a href="' . ($menu['menu_url'] ? route($menu['menu_url']) : 'javascript:void(0)') . '">
                                                <i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">' . __('menu' . '.' . str_replace(' ', '_', strtolower($menu['name']))) . '</span>' . ($menu['sub_menu'] ? '<i class="fa arrow"></i>' : '') . '</a>';
                                    if ($menu['sub_menu']) {
                                        $menuItem .= '<ul class="treeview-menu nav nav-third-level">';
                    
                                        foreach ($menu['sub_menu'] as $subMenu) {
                                            $menuItem .=
                                                '<li class=""><a class="hideMenu" href="' . ($subMenu['menu_url'] ? route($subMenu['menu_url']) : 'javascript:void(0)') . '"> <i class="fa fa-circle-o"></i> &nbsp;' . __('menu' . '.' . str_replace(' ', '_', strtolower($subMenu['name']))) . '</a></li>';
                                        }
                                        $menuItem .= '</ul>';
                                    }
                                    $menuItem .= '</li>';
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize hideMenu mdi mdi-account-multiple-plus"></i> Visitor Request <span
                                class="hide-menu hideMenu">&nbsp;<span class="fa arrow"></span></span>
                        </a>

                        <ul class="treeview-menu nav nav-second-level">
                            <li>
                                <a href="{{ route('visitor.request') }}">
                                    <i data-icon="/" class="linea-icon linea-basic fa-fw"></i>
                                    <span class="hideMenu"> All Visitor Request </span>
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        <footer class="footer text-center">
            {{ date('Y') }} &copy; <strong><a href="javascript:void(0)">OCEI HRMS</a>
