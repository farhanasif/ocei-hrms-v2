...
Route::group(['middleware' => ['preventbackbutton','auth']], function(){
    ...
    Route::group(['prefix' => 'empPerformance'], function () {
        ...
        Route::get('/store',['as' => 'employeePerformance.store', 'uses'=>'Performance\EmployeePerformanceController@store']);
        ...
        Route::get('/details/{id}',['as' => 'employeePerformance.details.downloadPdf', 'uses'=>'Performance\EmployeePerformanceController@performanceDetailsPDfDownload']);
    });
